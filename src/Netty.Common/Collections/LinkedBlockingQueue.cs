...
public class LinkedBlockingQueue<E> : IQueue<E> 
{
    /*
    ...
    private readonly object notEmpty = takeLock.newCondition();
    ...
    //@SuppressWarnings("serial") // Classes implementing Condition may be serializable.
    private readonly object notFull = putLock.newCondition();
     ...
     */
    private readonly class LBQSpliterator implements Spliterator<E> {
    ...
    @SuppressWarnings("unchecked")
    private bool bulkRemove(Predicate<? super E> filter) {
        bool removed = false;
