 ...
 */
    public abstract class AbstractInternalLoggerTest<T> {
        ...
        protected void testLevel(InternalLogLevel level) {
            ...
            Assert.False((Boolean) isXXEnabled.invoke(logger));
        ...
        Assert.True((Boolean) isXXEnabled.invoke(logger));
    ...
    protected abstract void setLevelEnable(InternalLogLevel level, bool enable) throws Exception;
    }
}